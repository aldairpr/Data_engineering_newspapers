...
is_well_formed_link = re.compile(r'^https?://.+/.+$') # i.e. https://www.somesite.com/something
...
def _save_articles(news_site_uid, articles):
    ...
    csv_headers = list(filter( lambda x: not x.startswith('_'), dir(articles[0]) ))
...
def _fetch_article(news_site_uid, host, link):
    logger.info('Star fetching article ar {}'.format(link))
